...
### 1. Subject-Specific Precision (No Generic Abstract Imagery)
...
### 2. High Contrast & Dark Theme Harmony
...
### 3. Aspect Ratio & Resolution Standards
...
- **Keywords**: Isometric perspective, base building, resource refineries, sci-fi military command center, laser turrets, tactical fog of war.
- **Example Prompt**: `"Isometric view of a futuristic sci-fi military outpost surrounded by resource refineries and defense turrets, dark night atmosphere, glowing blue energy shields, hyper-detailed RTS style"`
...
```text
Negative Rules: blurry, low-resolution, generic stock photo, white background, watermarked, text overlay, distorted geometry, overexposed, washed out colors, generic corporate office.
```
