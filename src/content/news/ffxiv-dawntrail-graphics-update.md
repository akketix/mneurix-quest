...
- **Texture & Material Shader Upgrades**: Character models, skin textures, metals, and environmental assets feature updated sub-surface scattering and ambient occlusion maps.
- **Dual-Dye System**: Armor pieces now support two independent color channels, expanding glamour customization options across all gear sets.
- **System Memory Requirements**: System RAM targets have been updated to 16 GB for optimal performance in 24-player Alliance Raid instances.

## High-End Raid Content

The AAC Light-heavyweight Savage raid series introduces updated boss encounter mechanics, weekly loot lockouts, and weapon token exchanges.
